...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      if (canvas && canvas.parentElement) {
        // Use the parent's size or fixed size if strictly controlled
        // For the SVG foreignObject, it will fill the 100% of the object
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#FFFFFF] p-8">
      <div className="relative">
        ...
        >
          <g id="Group 26">
            <path
              id="Vector 2"
              d="M23 116.188L40 143.688L0.5 145.188V359.188H216.5V249.688L321.5 182.188L206 0.688477L23 116.188Z"
              stroke="black"
            />
            {/* The mask definition */}
            <defs>
              <clipPath id="hmm-clip">
                <path d="M215 144.188H41L139.5 298.188L215 250.688V144.188Z" />
              </clipPath>
            </defs>

            {/* Render the dithered canvas clipped to the 'hmm' path */}
            <foreignObject
              x="0"
              y="0"
              width="323"
            ...
            {/* Re-render the stroke for 'hmm' over the dither */}
            <path
              id="hmm"
              d="M215 144.188H41L139.5 298.188L215 250.688V144.188Z"
              fill="none"
              stroke="black"
            />
          </g>
